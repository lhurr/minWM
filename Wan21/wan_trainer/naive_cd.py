import gc
import logging
from wan_utils.dataset import cycle
from wan_utils.dataset import LatentLMDBDataset
...
class Trainer:
    def __init__(self, config):
        ...
        # Import model AFTER distributed init so causal_model.py sees CleanCode SP infra
