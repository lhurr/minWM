...
from algorithms.dmd import compute_kl_gradient, dmd_generator_loss
...
class DMD(SelfForcingModel):
    ...
    def _compute_kl_grad(
        ...
        """
        # Step 1: Compute the fake score with optional CFG
        ...
        if self.fake_guidance_scale != 0.0:
            ...
            pred_fake_image = pred_fake_image_cond + self.fake_guidance_scale * (
        ...
        pred_real_image = pred_real_image_cond + self.real_guidance_scale * (
            pred_real_image_cond - pred_real_image_uncond
        )

        # Step 3: Compute the KL gradient using shared algorithm
        normalize_mode = "per_sample" if normalization else "none"
        grad = compute_kl_gradient(
            fake_x0=pred_fake_image,
            real_x0=pred_real_image,
            generator_output=estimated_clean_image_or_video,
    ...
    def compute_distribution_matching_loss(
        ...
        with torch.no_grad():
            ...
            viewmats = conditional_dict.get("viewmats", None)
            Ks = conditional_dict.get("Ks", None)
        ...
        # Step 3: Compute the DMD generator loss using shared algorithm
