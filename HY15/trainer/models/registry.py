...
_TEXT_TO_VIDEO_DIT_MODELS = {
    "HunyuanTransformer3DARActionModel": ("hyvideo", "transformer.ar_action_hunyuanvideo_1_5_transformer", "ARHunyuanVideo_1_5_DiffusionTransformer"),
    "HunyuanTransformer3DARActionProPEModel": ("hyvideo", "transformer.ar_action_hunyuanvideo_1_5_prope_transformer", "ARHunyuanVideo_1_5_DiffusionTransformer"),
    "CausalWanModel": ("wan", "causal_model", "CausalWanModel"),
}
