...
from trainer.distributed.communication_op import sequence_model_parallel_all_gather
from trainer.models.hyvideo.text_encoders.byt5 import ByT5Mapper
...
class ARHunyuanVideo_1_5_DiffusionTransformer(ModelMixin, ConfigMixin):
    ...
    def forward_bi(
        ...
        if is_tf:
            from trainer.models.hyvideo.transformer.flash_attn_no_pad import prepare_teacher_forcing_mask
            frame_seqlen = th * tw
