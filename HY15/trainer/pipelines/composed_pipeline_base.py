...
class ComposedPipelineBase(ABC):
    ...
    def from_pretrained(cls,
        ...
        if args is None or args.inference_mode:
            ...
            # Unify model paths: load_from_dir defaults to model_path
            if not trainer_args.load_from_dir:
                trainer_args.load_from_dir = model_path
    ...
    def load_hunyuan_modules(
        ...
        if "vae" in self._required_config_modules:
            vae_path = os.path.join(os.path.dirname(os.path.dirname(component_model_path)), "vae")
